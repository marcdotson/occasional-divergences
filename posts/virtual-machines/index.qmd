...
- EC2 instance using Ubuntu (not a WSL Linux instance)
...
SSH tunneling is available experimentally in Positron: https://github.com/posit-dev/positron/pull/4251 using a "lightly modified" version of Open Remote SSH (https://github.com/jeanp413/open-remote-ssh).
