...
I'm loooking for the simplest possible way to get computation started, and certainly having to create an image is a bottleneck for my bottleneck. Hasn't someone else written this blog post for me, please?
:::
...
Sharad's walkthrough (also see his Cloud Computing class):
...
- chmod 400 “keypair.pem” is UNIX-specific (read-only access)
...
- What about getting an S3 instance?
