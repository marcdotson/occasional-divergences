...
The most popular modeling library in Python is [scikit-learn](https://scikit-learn.org/stable/) (referred to as sklearn in code). This machine learning library is built on NumPy, matplotlib, and [SciPy](https://scipy.org)---a library for scientific computing. The name scikit-learn comes from its origin as a "scikit" or "SciPy Toolkit," a collection of extensions built for SciPy to provide specialized functions and methods.
