...
With the right mindset, it's easier to understand some of the things that Python is obsessed with that R simply isn't. However, the most important difference is that Python is an object-oriented programming language while R is all about functional programming. While *everything* in R is a function (for a typical user), using Python requires frequently keeping track of the difference between functions, methods, and attributes.
...
- pyenv and pip or [uv](https://docs.astral.sh/uv/) and venv or pdm?
- Positron or VS Code.
...
- What language you know influences the way you think about data?
- Lazy evaluation by tagging a data frame with `.lazy()`.

- Effective Polars?
- [Understanding Polars Expressions when you're used to pandas](https://www.youtube.com/watch?v=BgnPgssga90)
