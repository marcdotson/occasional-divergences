...
Introduction to the idea of facilitating statistical literacy by beginning with Bayesian inference. Collect resources and links. A teaching philosophy. The beginnings of a pedagogical paper.
...
|----|----|
| All unknowns (parameters, missing data, etc.) are random variables | Data is a random variable |
