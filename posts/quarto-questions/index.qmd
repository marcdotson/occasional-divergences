...
Here are a number of additional sources that I've found useful in updating my blog.
...
Making a multilingual publishing system requires leaning more heavily on a set of additional languages that link them: Markdown, YAML, and especially Pandoc. From what I've seen, it's a solid foundation for a powerful tool that I hope brings more people into the big tent of functionality that R Markdown has come to provide for R users specifically. It's not without limitations. The absence of a flexdashboard equivalent might be the biggest problem, but it's also one that the Quarto team has repeatedly said they're working on.
